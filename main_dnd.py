...
# WR2021: accuracy over validation, swinv2s:76.59%
# WW2020: accuracy over validation, swinv2s:68.97%
...
def train_model(model, train_loader, val_loader, test_loader, start_epoch, cfg):
    ...
    for epoch in range(start_epoch + 1, start_epoch + 1 + cfg.TRAIN.MAX_EPOCH):
        ...
        # if any([pg['lr'] <= cfg.TRAIN.LR * cfg.NGPUS * cfg.bsz / 4999.0 for pg in optimizer.param_groups]):
        #     print("=================Testing=================")
        #
        #     # inference
        #     if best_path:
